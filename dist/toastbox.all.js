...
(function(root, factory) {
  ...
  exports.dialog = function(options) {
    ...
    if (!options.reusable) {
      ...
      dialog.addEventListener('hide.bs.modal', function(e) {
        unbindModal(e, dialog);
      }, {
        once: true
      });
      dialog.addEventListener('hidden.bs.modal', function(e) {
        destroyModal(e, dialog);
      }, {
        once: true
      });
    }
    ...
    dialog.addEventListener('shown.bs.modal', function(e) {
      focusPrimaryButton(e, dialog);
    }, {
      once: true
    });
